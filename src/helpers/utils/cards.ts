...
export const TRAVEL_PARIS = Image.resolveAssetSource(
  require(`../../assets/cards/travel/paris.jpg`)
).uri;
export const TRAVEL_LONDON = Image.resolveAssetSource(
  require(`../../assets/cards/travel/london.jpg`)
).uri;
export const TRAVEL_GIZA = Image.resolveAssetSource(
  require(`../../assets/cards/travel/giza.jpg`)
).uri;


export const POPULAR_HOMELESS = Image.resolveAssetSource(
...
export const SITUATION_GOVNO = Image.resolveAssetSource(
